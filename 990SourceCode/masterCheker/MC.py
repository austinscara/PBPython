...
def FundDNUCheck(masterCreator):
	...
	if keys_with_Dnu:
		with open('\\\\Mowgli\\Research\\Fund Performance\\5500 & 990\\990 PF\\Master Creator\\DNU_KickBack.csv', 'wb') as DNU_DFunds:
...
os.chdir("\\\\Mowgli\\Research\\Fund Performance\\5500 & 990\\990 PF")
